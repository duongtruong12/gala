...
class GuestManagerController extends GetxController {
  static GuestManagerController get to => Get.find();
  ...
  Future<void> getData() async {
    final listDoc = await fireStoreProvider.getListUser(
        lastDocument: lastDoc, sort: TypeAccount.guest);
